...
| 👩‍🏫 Uddybende spørgsmål i simulatoren | Et sted, hvor der ikke er fire muligheder at vælge imellem | 65 opfølgende spørgsmål med modelsvar, to pr. simulering, valgt tilfældigt fra emnets pulje. Man siger svaret højt og vurderer selv – det er formatet, en mundtlig eksamen faktisk har |
| ✅ »Sidste tjek« | Et tal, man gerne vil have op, og en liste over, hvad der stadig mangler | Generate-then-compare: man får kun emnets navn og skal producere kernen fra hukommelsen, før facit vises. Forsøget på at hente frem er selve læringen, også når man ikke rammer |
| 🗺️ »Din plan« under Eksamen | Én klar næste handling frem for et dashboard | Faserne følger, hvad der faktisk betaler sig: bredde langt fra eksamen, hullerne og det mundtlige format tæt på, og kun genkaldelse plus søvn det sidste døgn. Hvert trin har en knap, så planen bliver til en handling |
